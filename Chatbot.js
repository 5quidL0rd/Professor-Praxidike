...
const botResponses = {
    ...
    "feeling": "Feeling. What a most perplexing phenomenon. Both plague and blessing, inconvenience and tribulation. I can't imagine a world without feeling. I would hardly have a reason to keep going without it. Yet sometimes, I find it is a hindrance.",
...
function sendMessageToBot(message) {
    ...
    } else if (lowerCaseMessage.includes("feel") || lowerCaseMessage.includes("emotion")) {
        botResponse = botResponses["feeling"];
    } else {
